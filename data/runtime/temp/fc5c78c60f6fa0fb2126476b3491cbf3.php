<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin/portal\admin_category\edit.html";i:1533709174;s:47:"E:\demo6\public\themes\admin\public\header.html";i:1529968518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form class="js-ajax-form" action="<?php echo url('AdminCategory/editPost'); ?>" method="post">
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <div class="form-group">
                            <label for="input-description">手机缩略图</label>
                            <div>
                                <input type="hidden" name="more[thumbnail_m]" class="form-control"
                                       value="<?php echo (isset($more['thumbnail_m']) && ($more['thumbnail_m'] !== '')?$more['thumbnail_m']:''); ?>" id="js-thumbnail_m-input">
                                <div>
                                    <a href="javascript:uploadOneImage('图片上传','#js-thumbnail_m-input');">
                                        <?php if(empty($more['thumbnail_m'])): ?>
                                            <img src="/themes/admin/public/assets/images/default-thumbnail.png"
                                                 id="js-thumbnail_m-input-preview"
                                                 width="135" style="cursor: pointer"/>
                                            <?php else: ?>
                                            <img src="<?php echo cmf_get_image_preview_url($more['thumbnail_m']); ?>"
                                                 id="js-thumbnail_m-input-preview"
                                            width="135" style="cursor: pointer"/>
                                        <?php endif; ?>
                                    </a>
