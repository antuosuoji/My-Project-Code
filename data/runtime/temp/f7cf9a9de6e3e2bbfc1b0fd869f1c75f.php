<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:35:"themes/admin/admin\index\index.html";i:1533524702;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <?php $submenus=$menus; function getsubmenu($submenus){ if(!(empty($submenus) || (($submenus instanceof \think\Collection || $submenus instanceof \think\Paginator ) && $submenus->isEmpty()))): foreach($submenus as $menu){ ?>
        <li style="background-color: #2c3e50;border-bottom: 1px dotted #959292;border-top: 0px">
            <?php 
                $menu_name=lang($menu['lang']);
                $menu_name=$menu['lang']==$menu_name?$menu['name']:$menu_name;
             if(empty($menu['items'])){ ?>
            <a href="javascript:openapp('<?php echo $menu['url']; ?>','<?php echo $menu['id']; ?>','<?php echo $menu_name; ?>',true);" style="background-color: #2c3e50;">
                <i class="fa fa-<?php echo (isset($menu['icon']) && ($menu['icon'] !== '')?$menu['icon']:'desktop'); ?>"></i>
                <span class="menu-text"> <?php echo $menu_name; ?> </span>
            </a>
            <?php }else{ ?>
            <a href="#" class="dropdown-toggle" style="background-color: #2c3e50;color: #cccaca;">
            ...
            <ul class="submenu" style="border-top: 1px dotted #959292;">
    ...
    <li style="border-bottom: 1px dotted #959292;border-top: 0px">
        <?php 
            $menu_name=lang($menu['lang']);
            $menu_name=$menu['lang']==$menu_name?$menu['name']:$menu_name;
         if(empty($menu['items'])){ ?>
        <a href="javascript:openapp('<?php echo $menu['url']; ?>','<?php echo $menu['id']; ?>','<?php echo $menu_name; ?>',true);" style="background-color: #2c3e50;border-bottom: 0px;border-top: 0px;color: #cccaca;">
        ...
        <?php }else{ ?>
        <a href="#" class="dropdown-toggle" style="background-color: #2c3e50;border-bottom: 0px dotted #959292;border-top: 0px;color: #cccaca;">
            <i class="fa fa-caret-right"></i>
            <span class="menu-text">
									<?php echo $menu_name; ?>
								</span>
    ...
    <li style="border-bottom: 1px dotted #959292;border-top: 0px">
        ...
        <a href="javascript:openapp('<?php echo $menu['url']; ?>','<?php echo $menu['id']; ?>','<?php echo $menu_name; ?>',true);" style="background-color: #2c3e50;border-bottom: 1px dotted #959292;border-top: 0px;color: #cccaca;">
...
<div class="navbar navbar-default">
    <div class="container-fluid" style="border-bottom: 3px solid #e91717;">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;padding-top:0px;"><img src="/static/images/logo.png" alt=""></a>
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-shortcuts" style="background-color: #2c3e50;border-bottom: 1px dotted #959292;" id="sidebar-shortcuts">
        ...
        <div id="nav-wrapper" style="background-color: #2c3e50;">
