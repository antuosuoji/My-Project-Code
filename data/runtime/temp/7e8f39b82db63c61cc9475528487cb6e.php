<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"themes/admin/admin\slide_item\add.html";i:1533708363;s:57:"D:\wyh\ld\shengshi\public\themes\admin\public\header.html";i:1529968518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-3">
                <table class="table table-bordered">
                        ...
                        <td>
                            <div style="text-align: center;">
                                ...
                                <a href="javascript:uploadOneImage('图片上传','#thumb');">
                                    <img src="/themes/admin/public/assets/images/default-thumbnail.png" id="thumb-preview"
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="post[image_m]" id="thumb_m" value="">
                                <a href="javascript:uploadOneImage('图片上传','#thumb_m');">
                                    <img src="/themes/admin/public/assets/images/default-thumbnail.png" id="thumb_m-preview"
                                         width="135" style="cursor: hand"/>
                                </a>
                                <input type="button" class="btn btn-sm"
