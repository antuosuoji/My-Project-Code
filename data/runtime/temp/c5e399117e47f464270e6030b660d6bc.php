<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"themes/admin/admin\main\index.html";i:1533629663;s:47:"E:\demo6\public\themes\admin\public\header.html";i:1529968518;}*/ ?>
  <div class="panel panel-default">
    ...
    <div class="panel-body home-info">
      <ul class="list-inline">
        ...
        <li>调试模式：<?php echo \think\Config::get('app_debug')?'yes':'no'; ?></li>
        <li>时区：<?php echo date_default_timezone_get(); ?></li>
        <li>环境信息：<?php echo \think\Request::instance()->server('SERVER_SOFTWARE'); ?></li>
      </ul>
    </div>
  </div>
<!DOCTYPE html>
...
<?php 
    \think\Hook::listen('admin_before_head_end',$temp5b6a97994a38d,null,false);
 ?>
</head>
<body>
...
<?php 
    \think\Hook::listen('admin_before_body_end',$temp5b6a97994a38d,null,false);
 ?>
</body>
</html>
