<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"themes/admin/admin\slide_item\edit.html";i:1533708546;s:57:"D:\wyh\ld\shengshi\public\themes\admin\public\header.html";i:1529968518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-3">
                <table class="table table-bordered">
                        ...
                        <td>
                            <div style="text-align: center;">
                                ...
                                <input type="button" class="btn btn-sm"
                                       onclick="$('#thumb-preview').attr('src','/themes/admin/public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;"
                                       value="取消图片">
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="post[image_m]" id="thumb_m" value="<?php echo (isset($result['image_m']) && ($result['image_m'] !== '')?$result['image_m']:''); ?>">
                                <a href="javascript:uploadOneImage('图片上传','#thumb_m');">
                                    <?php if(empty($result['image_m'])): ?>
                                        <img src="/themes/admin/public/assets/images/default-thumbnail.png"
                                             id="thumb_m-preview" width="135" style="cursor: hand"/>
                                        <?php else: ?>
                                        <img src="<?php echo cmf_get_image_preview_url($result['image_m']); ?>" id="thumb_m-preview"
                                             width="135" style="cursor: hand"/>
                                    <?php endif; ?>
                                </a>
                                <input type="button" class="btn btn-sm"
                                       onclick="$('#thumb_m-preview').attr('src','/themes/admin/public/assets/images/default-thumbnail.png');$('#thumb_m').val('');return false;"
                                       value="取消图片">
                            </div>
                        </td>
                    </tr>
